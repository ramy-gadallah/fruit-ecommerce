...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('product') }}
@endsection
@section('page_name') {{ trns('product') }} @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('product') }} {{ config()->get('app.name') }}</h3>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">{{ trns('Category') }}</th>
                                <th class="min-w-50px">{{ trns('Unit') }}</th>
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('product.destroy',':id')}}');
        // Add Using Ajax
