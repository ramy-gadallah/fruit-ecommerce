...
@endsection
@section('page_name') {{ trns('Unit') }} @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('Unit') }} {{ config()->get('app.name') }}</h3>
                    <div class="">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('units.index')}}', columns);
        // Delete Using Ajax
        deleteScript('{{route('units.destroy',':id')}}');
        // Add Using Ajax
        showAddModal('{{route('units.create')}}');
        addScript();
        // Add Using Ajax
        showEditModal('{{route('units.edit',':id')}}');
        editScript();
    </script>
@endsection
