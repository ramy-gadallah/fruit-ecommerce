...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('jobs') }}
@endsection
@section('page_name') {{ trns('jobs') }} @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('jobs') }} {{ config()->get('app.name') }}</h3>
                    <div class="">
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('jobs.destroy',':id')}}');
        // Add Using Ajax
