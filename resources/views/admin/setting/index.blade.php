                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="title_arabic" id="title_ar"
                                           value="{{isset($setting) ? $setting->title_ar : ''}}">
                                </div>
                                <div class="col-6">
                                    <label for="title_en" class="form-control-label">{{ trns('title_english') }}</label>
                                    <input type="text" class="form-control" name="title_english" id="title_en"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="location_arabic" id="location_ar"
                                           value="{{isset($setting) ? $setting->location_ar : ''}}">
                                </div>
                                <div class="col-6">
                                    <label for="location_en" class="form-control-label">{{ trns('location_english') }}</label>
                                    <input type="text" class="form-control" name="location_english" id="location_en"
