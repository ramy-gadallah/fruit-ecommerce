...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('partner') }}
@endsection
@section('page_name') {{ trns('partner') }} @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('partner') }} {{ config()->get('app.name') }}</h3>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">{{ trns('link') }}</th>
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('partners.destroy',':id')}}');
        // Add Using Ajax
