...
@section('title')
    {{ config()->get('app.name') }} | {{ trns('Category') }}
@endsection
@section('page_name') {{ trns('contact') }} @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ trns('contact') }} {{ config()->get('app.name') }}</h3>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">{{ trns('subject') }}</th>
                                <th class="min-w-50px">{{ trns('message') }}</th>
...
@section('ajaxCalls')
    <script>
        ...
        // Delete Using Ajax
        deleteScript('{{route('contact_us.destroy',':id')}}');
        // Add Using Ajax
